        ...
        # #code for single point
            ...
            if len(bboxes_l)>0:
                ...
                if result_depth<effective_range and conf_sums_local[0]>max_min:
                    ...
                    rectified_left_points_results_temp=[calculate_median(rectified_left_points_results)]
                    # print(rectified_left_points_results_temp)
                    for rectified_left_points_result in rectified_left_points_results_temp:
                        # print(rectified_left_points_result)
                        for i in rectified_left_points_result:
                            for pr in i:
