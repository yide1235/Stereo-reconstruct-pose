...
def addMouseCallback(winname, param, callbackFunc=None, info="%",depth=None,disparity=None):
    ...
    def default_callbackFunc(event, x, y, flags, param):
        if event == cv2.EVENT_LBUTTONDOWN:
            ...
            # cv2.circle(depth, (x, y), 5, (0, 255, 0), -1)
            # cv2.circle(disparity, (x, y), 5, (0, 255, 0), -1)
