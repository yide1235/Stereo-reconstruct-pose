...
// //this is the Edward's calibration for K1 D1 K2 D2 R T, and Evan's for H1 and H2
...
// // //this is pure Evan's calibration
// bool load_stereo_coefficients(cv::Mat &K1, cv::Mat &D1, cv::Mat &K2, cv::Mat &D2, cv::Mat &R, cv::Mat &T, cv::Mat &E, cv::Mat &F, cv::Size &imageSize, cv::Mat &R1, cv::Mat &R2, cv::Mat &P1, cv::Mat &P2, cv::Mat& H1, cv::Mat& H2) {
//     // Directly setting the imageSize
//     imageSize = cv::Size(1920, 1080);

//     // Directly setting the matrices
//     K1 = (cv::Mat_<double>(3, 3) << 1.43164182e+03, 0.00000000e+00, 9.25759573e+02,
//                                    0.00000000e+00, 1.43229729e+03, 5.45828914e+02,
//                                    0.0, 0.0, 1.0);
//     D1 = (cv::Mat_<double>(1, 5) << -0.39241532,  0.14710836, -0.00290526,  0.00262518, -0.02885507);
//     K2 = (cv::Mat_<double>(3, 3) << 1.43253801e+03, 0.00000000e+00, 9.75664827e+02,
//                                    0.00000000e+00, 1.43302284e+03, 5.32614239e+02,
//                                    0.0, 0.0, 1.0);
//     D2 = (cv::Mat_<double>(1, 5) << -0.37858269 , 0.11124954, -0.0011131 ,  0.00267528 ,-0.00040241);
//     R = (cv::Mat_<double>(3, 3) << 1, 0,0, 
//                                 0,1, 0,
//                                 0, 0,1);
//     T = (cv::Mat_<double>(3, 1) << 65, 0,
//                                     0);
